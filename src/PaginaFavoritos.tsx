...
import { buscarPacientes, buscarFavoritos, removerFavorito, buscarTodosAcompanhamentos, buscarAcompanhamentos, atualizarPaciente } from "./pocketbase";
...
const ESCOLAS = [
  "ESCOLA MUNICIPAL PONTE DOS JESUITAS","ESCOLA MUNICIPAL RICARDO BRENTANI","GET ARMANDO KLABIN","ESCOLA MUNICIPAL ROBERTO CIVITA","EDI PROFESSOR RUBEM GONCALVES","EDI PROFESSOR ANTONIO ALFREDO MERCADANTE","EDI PROFESSORA MARIA MESQUITA DE SIQUEIRA","ESCOLA MUNICIPAL PROFESSOR COQUEIRO","ESCOLA MUNICIPAL ANDRE VIDAL DE NEGREIROS","ESCOLA MUNICIPAL PESTALOZZI","ESCOLA MUNICIPAL PROFESSOR DARCY ARAUJO DE MIRANDA","ESCOLA MUNICIPAL ESC ESP DOUTOR HELIO PELLEGRINO","ESCOLA MUNICIPAL PROFESSORA ZELIA CAROLINA DA SILVA","CIEP 1º DE MAIO","CRECHE MUNICIPAL CRIANCA FELIZ","CRECHE MUNICIPAL SEMENTINHA DO AMOR","CRECHE MUNICIPAL IRINEA DOS SANTOS PAIVA","ESTADUAL PROFESSORA VANIA DO AMARAL MATIAS EDDE","ESCOLA MUNICIPAL PROFESSOR JORGE GONCALVES FARINHA","ESCOLA MUNICIPAL MEDALHISTA OLIMPICO ROBSON DONATO CONCEICAO","ESCOLA MUNICIPAL MEDALHISTA OLIMPICO THIAGO BRAZ DA SILVA","CRECHE MUNICIPAL MARLENE DA SILVA CARDOSO","CRECHE MUNICIPAL MARCOLINA","EDI MEDALHISTA OLIMPICA POLIANA OKIMOTO","EDI MEDALHISTA OLIMPICO ERLON DE SOUZA SILVA","ESCOLA MUNICIPAL PROFESSORA ZULMIRA TELLES DA COSTA","ESCOLA MUNICIPAL JOAQUIM DA SILVA GOMES","ESCOLA MUNICIPAL MARINHEIRO JOAO CANDIDO","ESCOLA MUNICIPAL LIBERDADE","ESCOLA MUNICIPAL SINDICALISTA CHICO MENDES","ESCOLA MUNICIPAL PROFESSORA DIONE FREITAS FELISBERTO DE CARVALHO","CIEP PAPA JOAO XXIII","CRECHE MUNICIPAL SEMPRE VIDA VALE DO SOL","CRECHE MUNICIPAL AYRTON SENNA","CRECHE MUNICIPAL AMANHECER DE LUZ","CRECHE MUNICIPAL LEUZA MARINS NOVAES S SANTOS","CRECHE MUNICIPAL ZACARIAS - O TRAPALHAO","EDI LARYSSA SILVA MARTINS","EDI GUANDU","EDI PROFESSORA ROSA MARIA ALVES DE OLIVEIRA","EDI PROFESSORA SOLANGE INACIA DE SA LACERDA","CRECHE MUNICIPAL SEMPRE VIDA ELZA RABELO DE ANDRADE","EDI ELIZABETH PAPERA","EDI RENE BISCAIA RAPOSO","DEPUTADO BOCAYUVA CUNHA","RAUL RYFF","ESCOLA MUNICIPAL VIVALDO RAMOS DE VASCONCELOS","CIEP ROBERTO MORENA","CRECHE MUNICIPAL TRINTA E UM DE OUTUBRO","CRECHE MUNICIPAL DANIELA PEREZ","CRECHE MUNICIPAL DJANIRA MARIA RAMOS","EDI LARISSA DOS SANTOS ATANAZIO","ESCOLA MUNICIPAL IPEG","IVO PITANGUY","CIEP MAJOR MANOEL GOMES ARCHER","CRECHE MUNICIPAL MIRIAM PIRES","ESCOLA MUNICIPAL PROFESSOR ARTHUR THIRE","ESCOLA MUNICIPAL PROFESSORA SONIA MOTA MOLISANI","CRECHE MUNICIPAL ADALTO BASTOS","ESCOLA MUNICIPAL RONALD DE CARVALHO","ESCOLA MUNICIPAL TENENTE RENATO CESAR","ESCOLA MUNICIPAL BENTO DO AMARAL COUTINHO","CRECHE MUNICIPAL SEMPRE VIDA PARQUE DE SANTA CRUZ","EDI PROFESSORA CARMEN FRAGA DE ARAUJO","MARIO DE ANDRADE","ESCOLA MUNICIPAL LOURDES DE LIMA ROCHA","ESCOLA MUNICIPAL MERALINA DE CASTRO","ESCOLA MUNICIPAL EMILIANO GALDINO","ESCOLA MUNICIPAL MARIA DE JESUS OLIVEIRA","CRECHE MUNICIPAL ESTRELA DALVA","ESCOLA MUNICIPAL ESPANHA","ESCOLA MUNICIPAL RIBEIRO COUTO","ESCOLA MUNICIPAL DOUTOR JOSE ANTONIO CIRAUDO","ESCOLA MUNICIPAL FRANCISCO CALDEIRA DE ALVARENGA","ESCOLA MUNICIPAL PRIMÁRIO VERA LÚCIA CHAVES","ESCOLA MUNICIPAL HAYDEA VIANNA FIUZA DE CASTRO","ESCOLA MUNICIPAL PROFESSORA SILVIA DE ARAUJO TOLEDO","CRECHE MUNICIPAL MARIA HELENA PAPERA MONTEIRO","JOAO VITTA","ESCOLA MUNICIPAL PREFEITO JOAO CARLOS VITAL","ESCOLA MUNICIPAL GEO JOSE DE MELLO","ESCOLA MUNICIPAL CORONEL BERTHIER","ESCOLA MUNICIPAL PRINCESA ISABEL","ESCOLA MUNICIPAL GEO FERNANDO DE AZEVEDO","ESCOLA MUNICIPAL SOCRATES GALVEAS","ESCOLA MUNICIPAL PROFESSORA EULALIA RODRIGUES DE OLIVEIRA VIEIRA","CIEP BARAO DE ITARARE","EDI PROFESSOR CELSO DE ALMEIDA CHAVES","ESTADUAL BARAO DO RIO BRANCO","ESTADUAL PROFESSOR OZEAS GOMES LARANGEIRAS","ESCOLA MUNICIPAL NAIR DA FONSECA","EDI PROFESSORA INAIA WANDERLEY CARMO","ESCOLA MUNICIPAL NELSON ROMERO","ESCOLA MUNICIPAL FELIPE CAMARAO","CIEP MINISTRO MARCOS FREIRE","CIEP DEPUTADO ULYSSES GUIMARAES","CRECHE MUNICIPAL CHAVE DO TAMANHO","CRECHE MUNICIPAL SEMPRE VIDA ESTRELA DO ALAGADO","EDI PROFESSORA MARIA LUIZA JOBIM DE QUEIROZ","EDI THAMIRIS DE ANDRADE DA SILVA SANTOS","ESCOLA MUNICIPAL JULIO CESARIO DE MELO","ESCOLA MUNICIPAL PRIMARIO PARALIMPIADAS RIO 2016","ESCOLA MUNICIPAL EMILINHA BORBA","ESCOLA MUNICIPAL GINASIO PROFESSOR NEEMIAS RODRIGUES DE MELLO","S ARNOLDO ABRUZZINI DA FONSECA","ESCOLA MUNICIPAL WALQUIR PEREIRA","ESCOLA MUNICIPAL PROFESSORA CLARA LUCIA DE SOUSA","CRECHE MUNICIPAL NARIZINHO","CRECHE MUNICIPAL PEDRINHO","CRECHE MUNICIPAL VOVO BENTA","CRECHE MUNICIPAL MERILUCE DE OLIVEIRA MULLER","EDI PROFESSORA KATIA MIRANDA SANTOS","EDI MARIA ROSANGELA OLIVEIRA TIA NEGUINHA","EDI PROFESSORA LILIA CHAVES DA COSTA","ESCOLA MUNICIPAL PROFESSORA MARIA HELENA ALVES PORTILHO","ESCOLA MUNICIPAL JAPAO","ESCOLA MUNICIPAL ROBERTO COELHO","ESCOLA MUNICIPAL ADALGIZA NERI","CRECHE MUNICIPAL CANTINHO DA TIA DOLORES","CRECHE MUNICIPAL SANTA TEREZINHA","EDI SAO FERNANDO","ESCOLA MUNICIPAL GENERAL GOMES CARNEIRO","ESCOLA MUNICIPAL EDUARDO RABELO","ESCOLA MUNICIPAL PROFESSORA MARIA SANTIAGO","ESCOLA MUNICIPAL LUIS CAETANO DE OLIVEIRA","ESCOLA MUNICIPAL PROFESSOR FRANCISCO JOSE ANTONIO","CIEP ISMAEL NERY","ESCOLA MUNICIPAL PROFESSORA LEILA MEHL MENEZES DE MATTOS","ESCOLA MUNICIPAL GANDHI","ESCOLA MUNICIPAL MARIO LAGO","CRECHE MUNICIPAL INSPETOR HERALDO CARVALHO DE SOUSA","EDI PROFESSORA RAQUEL KELLY LANERA","ESCOLA MUNICIPAL PROFESSORA FLAVIA DOS SANTOS SOARES","ESCOLA MUNICIPAL ALVARO VALLE","CIEP ALBERTO PASQUALINI","CRECHE MUNICIPAL MAOS PEQUENAS","EDI SARGENTO IZO GOMES PATRICIO","EDI PROFESSORA ROSELE NICOLAU JORGE COUTINHO","EDI JOAO CORREA","ESCOLA MUNICIPAL PROFESSOR JOAO GUALBERTO JORGE DO AMARAL","ESCOLA MUNICIPAL MARECHAL PEDRO CAVALCANTI","ESCOLA MUNICIPAL MANOEL PORTO FILHO","CIEP DOUTOR NELSON HUNGRIA","CRECHE MUNICIPAL JARDIM DOS VIEIRAS","CRECHE MUNICIPAL SEMPRE VIDA TERRA DA PAZ","EDI GOUVEIAS","ESCOLA MUNICIPAL FRANKLIN TAVORA","EDI GEOGRAFO AZIZ ABSABER","ESCOLA MUNICIPAL REPUBLICA ARABE DA SIRIA","ESCOLA MUNICIPAL MIGUEL CALMON","EDI CESARINHO","ESCOLA MUNICIPAL ALDEBARA","ESCOLA MUNICIPAL OTELO DE SOUZA REIS","CIEP MAESTRO HEITOR VILLA LOBOS","CRECHE MUNICIPAL SEMPRE VIDA ANTARES","EDI ERASMO CARLOS","EDI GAL COSTA","REDE PRIVADA","NÃO MATRICULADO","OUTROS",
];
...
export default function PaginaFavoritos({ usuarioId, usuarioUnidade, usuarioRole, onNavigateAcompFiltered }: { usuarioId: string; usuarioUnidade: string; usuarioRole: string; onNavigateAcompFiltered: (pacienteId: string) => void }) {
  ...
  const sexosDisponiveis = [...new Set(favoritos.map(p => p.sexo).filter(Boolean))].sort();
  const racasDisponiveis = [...new Set(favoritos.map(p => p.raca).filter(Boolean))].sort();
  const nutricionaisDisponiveis = [...new Set(favoritos.map(p => p.estado_nutricional).filter(Boolean))].sort();
  const vacinaisDisponiveis = [...new Set(favoritos.map(p => p.situacao_vacinal).filter(Boolean))].sort();
  const beneficiosDisponiveis = [...new Set(favoritos.map(p => p.recebe_algum_beneficio).filter(Boolean))].sort();
  const escolasDisponiveis = [...new Set(favoritos.map(p => p.unidade_escolar).filter(Boolean))].sort();
  ...
  useEffect(() => { setPagina(1); }, [favoritos, busca, filtroUnidade, filtroEquipe, filtroMicroarea, filtroSexo, filtroRaca, filtroNutricional, filtroVacinal, filtroBeneficio, filtroEscola]);
                          ...
                          <div className="flex flex-col items-center gap-2">
                            <div className="flex items-center gap-1.5 rounded-xl bg-gradient-to-br from-slate-50 to-white px-3 py-1.5 ring-1 ring-slate-200/70 shadow-sm">
                              <button
                                ...
                                className="flex h-7 w-7 items-center justify-center rounded-lg bg-amber-50 ring-1 ring-amber-200/50 transition-all duration-200 hover:scale-110 hover:bg-amber-100 hover:shadow-md"
                      ...
                      <tr key={p.id} className="transition-colors hover:bg-slate-50/50">
                        ...
                        <td className="px-2 py-2.5 text-center align-middle" style={{ width: '30%' }}>
                          <div className="flex flex-col items-center gap-0.5">
                            ...
                            {p.equipe && <span className="text-[8px] font-bold text-slate-800 leading-tight">{p.equipe}</span>}
      ...
      {pacienteModal && createPortal(
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4" onClick={() => { setPacienteModal(null); setEditando(false); }}>
          ...
          <div className="relative flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl" onClick={(e) => e.stopPropagation()}>
            {/* ── Header premium ── */}
            <div className="relative flex items-center gap-4 bg-gradient-to-r from-cyan-900 via-cyan-800 to-teal-800 px-6 py-5">
              <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-cyan-400 to-teal-400 text-xl font-black text-white shadow-lg shadow-cyan-500/30 ring-2 ring-white/20">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-0.5 flex items-center gap-2 text-xs font-semibold text-white/60">
                  ...
                  {pacienteModal.raca && <span className="hidden sm:inline">&middot; {pacienteModal.raca}</span>}
                </div>
              </div>
              <div className="flex items-center gap-1.5">
                {!editando ? (
                  <>
                    <button onClick={() => iniciarEdicao(pacienteModal)} className="flex items-center gap-1.5 rounded-lg bg-white/10 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-white/90 backdrop-blur-sm ring-1 ring-white/10 transition-all hover:bg-white/20 hover:text-white hover:ring-white/25">
                      <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg>
                      Editar
                    </button>
                    <button onClick={() => { setPacienteModal(null); setEditando(false); }} className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-white/5 text-white/50 ring-1 ring-white/10 transition-all hover:bg-white/15 hover:text-white">
                  ...
                  <>
                    ...
                    <button onClick={() => setEditando(false)} className="flex items-center gap-1.5 rounded-lg bg-white/10 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-white/90 ring-1 ring-white/10 transition-all hover:bg-white/20">
                      Cancelar
                    </button>
                  </>
                )}
              ...
              <div className="rounded-xl border-l-4 border-emerald-500 bg-gradient-to-r from-emerald-50/80 to-white p-3.5">
                ...
                <div>
                  ...
                  {editando ? (
                    ...
                    <p className="text-sm font-bold text-slate-800">{pacienteModal.unidade_escolar || "\u2014"}</p>
                  )}
                </div>
              </div>
                    ...
                    {ultimosAcomps.map((a) => (
                      <div key={a.id} className="flex items-start gap-2.5 rounded-lg bg-white/60 px-3 py-2 ring-1 ring-black/[0.03] transition-colors hover:bg-white">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {a.observacoes && (
                            <p className="mt-0.5 text-[10px] font-semibold text-slate-400 leading-snug break-words">{a.observacoes}</p>
                          )}
                        </div>
                      </div>
                    ))}

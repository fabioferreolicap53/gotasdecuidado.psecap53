                      ...
                      <tr key={p.id} className="transition-colors hover:bg-slate-50/50">
                        ...
                        <td className="px-2 py-2.5 text-center align-middle" style={{ width: '20%' }}>
                          <div className="flex flex-col items-center gap-0.5">
                            ...
                            {p.recebe_algum_beneficio && <span className="inline-flex items-center rounded-full bg-green-50 px-1 py-px text-[6px] font-bold text-green-700 border border-green-100">{p.recebe_algum_beneficio}</span>}

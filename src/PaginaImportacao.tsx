...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  data_ultima_cons_oriclista: ["ULT_CONSULTA", "DATA_ULTIMA_CONS_ORICLISTA", "DATA ULTIMA CONS ORICLISTA", "DATA ULTIMA CONSULTA", "DATA ULTIMA CONS", "DATA_ULTIMA_CONS_DENTISTA", "DATA ULTIMA CONS DENTISTA"],

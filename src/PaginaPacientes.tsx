                        ...
                        <td className="px-2 py-2 text-center align-top">
                          <div className="flex flex-col items-center gap-1">
                            ...
                            <div className="flex w-full flex-col gap-0.5">
                              ...
                              <button onClick={() => abrirModal(p)} className="group/btn flex w-full items-center justify-center gap-1 rounded-lg border border-slate-200/80 bg-white px-2 py-1.5 text-[9px] font-bold uppercase tracking-wider text-slate-500 shadow-sm transition-all duration-200 hover:border-bordo-200 hover:bg-bordo-50/50 hover:text-bordo-800 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0">
                        ...
                        <td className="px-1 py-2 text-center align-middle" style={{ width: '20%' }}>
                          <div className="flex flex-col items-center gap-px">
                            ...
                            <div className="flex w-full flex-col gap-px">
                              ...
                              <button onClick={() => abrirModal(p)} className="group/btn flex w-full items-center justify-center gap-1 rounded border border-slate-200/80 bg-white px-1 py-1 text-[7px] font-bold uppercase tracking-wider text-slate-500 shadow-sm transition-all duration-200 hover:border-bordo-200 hover:bg-bordo-50/50 hover:text-bordo-800 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0">
                                <svg className="h-2.5 w-2.5 flex-shrink-0 transition-transform duration-200 group-hover/btn:scale-110" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z"/></svg>
                                Det.
                              </button>
                            </div>

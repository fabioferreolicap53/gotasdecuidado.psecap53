...
export default function PaginaResumo({ usuarioUnidade }: { usuarioUnidade: string }) {
  ...
  const pizzaOption = {
    ...
    series: [{
      ...
      emphasis: { scale: true, scaleSize: 12, itemStyle: { shadowBlur: 20, shadowColor: "rgba(0,0,0,0.15)" } },
  ...
  const donutOption = {
    ...
    series: [{
      ...
      label: { show: true, position: "outside", fontSize: 13, fontWeight: "900", formatter: "{b}\n{d}%", rich: { b: { fontSize: 11, fontWeight: "bold", color: "#64748b", lineHeight: 18 }, d: { fontSize: 18, fontWeight: "900", color: "#1e293b", lineHeight: 26 } } },
      labelLine: { length: 16, length2: 12, lineStyle: { color: "#cbd5e1", width: 2 }, smooth: true },
      emphasis: { scale: true, scaleSize: 10, itemStyle: { shadowBlur: 20, shadowColor: "rgba(0,0,0,0.12)" } },
  ...
  const contatoOption = {
    ...
    series: [{
      ...
      label: { show: true, position: "outside", fontSize: 13, fontWeight: "900", formatter: "{b}\n{d}%", rich: { b: { fontSize: 11, fontWeight: "bold", color: "#64748b", lineHeight: 18 }, d: { fontSize: 18, fontWeight: "900", color: "#1e293b", lineHeight: 26 } } },
      labelLine: { length: 16, length2: 12, lineStyle: { color: "#cbd5e1", width: 2 }, smooth: true },
      emphasis: { scale: true, scaleSize: 10, itemStyle: { shadowBlur: 15, shadowColor: "rgba(0,0,0,0.1)" } },
